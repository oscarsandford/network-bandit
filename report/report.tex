...
of the bunch, while $\varepsilon$-first was slightly behind due to its startup exploration phase. % is it worth mentioning how the softmax based algs and eps-g greedy did?
...
% Future Work: Probably just consists of how we could implement the POKER algorithm, and some of the other algorithms in the related works such as the gossip algorithms. 
% Could also discuss how increasing the number of peers within the network may change the results of how the algorithm performs. Exploring an environment where there is 
% more stochastic features may also be interesting.
